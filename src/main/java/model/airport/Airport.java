...
public class Airport {
    ...
    public Airport sortByMaxDistance() {
       planes.sort((Plane firstPlane, Plane secondPlane)->firstPlane.getMaxFlightDistance() - secondPlane.getMaxFlightDistance());
        return this;
    }

    public Airport sortByMaxSpeed() {
        planes.sort((Plane firstPlane, Plane secondPlane)->firstPlane.getMaxSpeed() - secondPlane.getMaxSpeed());
        return this;
    }

    public Airport sortByMaxLoadCapacity() {
        planes.sort((Plane firstPlane, Plane secondPlane)->firstPlane.getMaxLoadCapacity() - secondPlane.getMaxLoadCapacity());
        return this;
    }
